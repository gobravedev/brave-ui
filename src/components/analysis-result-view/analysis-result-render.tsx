...
const EditParamsPanel = lazy(() => import("../edit-params/components/edit-params"));
...
const viewMapping: {
    ...
    component: React.ComponentType<any>;
        ...
        { key: "description", label: "description", component: ComponentDescription },
        { key: "llmAnalysis", label: "llmAnalysis", component: LLMAnalysis },
...
const AnalysisResultRender: FC<any> = ({ view, ...rest }) => {
    if (!view) return null
...
export default memo(AnalysisResultRender);